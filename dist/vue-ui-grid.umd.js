...
function (_Vue) {
  ...
  function VGrid() {
    ...
    _this.limit = _this.perPage ? _this.perPage : _this.$vgrid.perPage; // @ts-ignore
...
var BasicGrid_component = normalizeComponent(
  ...
  BasicGridvue_type_template_id_6bd84922_lang_pug_render,
  staticRenderFns,
  false,
  null,
  null,
